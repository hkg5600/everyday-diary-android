...
interface DiaryService {
    ...
    fun getDiaryByDate(token: String, id: Int): Single<retrofit2.Response<Response<DiaryListResponse>>>
}

class DiaryServiceImpl(private val api: DiaryApi) : DiaryService {
    override fun getDiaryByDate(token: String, id: Int) = api.getDiaryByDate(token, "/api/diary/diary-month/$id/")
